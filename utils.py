...
def get_dataset(dataset_name, root, source, target, train_source_transform, val_transform, multi=False, train_target_transform=None):
    ...
    return train_source1_dataset, train_source2_dataset,train_source3_dataset,train_source4_dataset,train_source5_dataset, train_source_dataset, train_target_dataset, val_dataset, test_dataset, num_classes, class_names
...
def validate(val_loader, model, args, device) -> float:
    ...
    with torch.no_grad():
        ...
        if confmat:
            per_class_accuracy = confmat.format(args.class_names)
            for class_name, per_accuracy in per_class_accuracy.items():
                print(f'{class_name}: {per_accuracy:.1f}')
